...
public class OxidizableScaffoldingBlock extends ScaffoldingBlock implements PolymerBlock,
  ...
  public static final BlockState POLYMER_BLOCK_STATE_TOP = PolymerBlockResourceUtils.requestBlock(
      BlockModelType.TRANSPARENT_BLOCK, BLOCK_MODEL_TOP);
  public static final BlockState POLYMER_BLOCK_STATE_BOTTOM = PolymerBlockResourceUtils.requestBlock(
      BlockModelType.TRANSPARENT_BLOCK, BLOCK_MODEL_BOTTOM);
...
//      BlockModelType.TRANSPARENT_BLOCK_WATERLOGGED, BLOCK_MODEL_BOTTOM);
  ...
  public BlockState getPolymerBlockState(BlockState state, PacketContext context) {
    if (state.get(BOTTOM)) {
      return POLYMER_BLOCK_STATE_BOTTOM;
    } else {
      return POLYMER_BLOCK_STATE_TOP;
    }
  }
